...
public:
	...
	static constexpr GLenum SCRATCH_COLOR_ATTACHMENT_TEXTURE_UNIT = GL_TEXTURE5;
	static constexpr GLenum BACKGROUND_TEXTURE_UNIT = GL_TEXTURE6;
	static constexpr GLenum TEXTURE_TEXTURE_UNIT = GL_TEXTURE7;
